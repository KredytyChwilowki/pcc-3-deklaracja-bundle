...
use KCH\Bundle\PCC3Bundle\Service\XmlToDeclarationTransformer;
use KCH\PCC3\Deklaracja;
use PHPUnit\Framework\TestCase;

class XmlToDeclarationTransformerTest extends TestCase
{
    public function testSimpleGenerationEmptyDeclaration()
    {
        $declarationToXmlTransformer = new XmlToDeclarationTransformer(Deklaracja::class);
        $result = $declarationToXmlTransformer->transform('<?xml version="1.0" encoding="UTF-8"?>
<Deklaracja xmlns="http://crd.gov.pl/wzor/2015/12/11/2973/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    ...
    <PozycjeSzczegolowe>
        ...
        <P_22>1</P_22>
        <P_23>1</P_23>
        <P_24>UMOWA KUPNA-SPRZEDAŻY PRAW DO POŻYCZKI.</P_24>
        <P_25>1348</P_25>
        <P_26>13</P_26>
        <P_47>13</P_47>
        <P_54>13</P_54>
    ...
    <Pouczenie2>W przypadku niezapłacenia w obowiązującym terminie kwoty podatku od czynności cywilnoprawnych z poz. 54 lub wpłacenia jej w niepełnej wysokości, niniejsza deklaracja stanowi podstawę do wystawienia tytułu wykonawczego, zgodnie z przepisami ustawy z dnia 17 czerwca 1966 r. o postępowaniu egzekucyjnym w administracji (Dz. U. z 2014 r. poz. 1619, z późn. zm.).</Pouczenie2>
        ...
        $this->assertInstanceOf(Deklaracja::class, $result);
    }
}